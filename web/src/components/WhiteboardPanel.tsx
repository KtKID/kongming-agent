...
export function WhiteboardPanel({
  ...
  return (
    <aside className="flex h-full w-[26rem] min-w-[22rem] shrink-0 flex-col border-l border-border bg-[linear-gradient(180deg,rgba(251,246,229,0.98),rgba(247,239,214,0.92))]">
      <div className="border-b border-amber-200/70 px-4 py-4">
        <div className="flex items-start justify-between gap-3">
          <div className="space-y-1">
            <div className="text-[11px] font-semibold uppercase tracking-[0.22em] text-amber-900/55">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="rounded-full border border-amber-300/70 bg-white/70 px-2 py-0.5 text-[11px] text-amber-900/70">
                markdown cards
              </span>
            </div>
            <p className="max-w-xs text-xs leading-5 text-stone-700/75">
          ...
          <Button
            ...
            className="shrink-0 border-amber-300/80 bg-white/80 text-stone-900 hover:bg-white"
          >
      ...
      <div className="min-h-0 flex-1 overflow-hidden p-3">
        <div
          ref={boardRef}
          className={cn(
            "relative h-full overflow-hidden rounded-[1.5rem] border border-amber-200/80",
            "bg-[linear-gradient(180deg,rgba(255,251,236,0.96),rgba(250,244,220,0.96))] shadow-sm",
          )}
        >
          <div className="pointer-events-none absolute left-4 top-4 z-10 inline-flex rounded-full border border-amber-300/80 bg-white/85 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.2em] text-amber-900/70 shadow-sm">
            白板区域
          </div>
          <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(to_right,rgba(180,150,80,0.12)_1px,transparent_1px),linear-gradient(to_bottom,rgba(180,150,80,0.12)_1px,transparent_1px)] bg-[size:18px_18px] opacity-[0.22]" />
          <div className="pointer-events-none absolute right-5 top-5 h-6 w-6 rounded-full border border-rose-300/80 bg-rose-300/70 shadow-sm" />
          <div className="relative h-full overflow-y-auto scrollbar-thin">
            {cards.length === 0 ? (
              <div className="flex h-full items-center justify-center p-5">
                <div className="w-full max-w-sm rounded-[1.5rem] border border-dashed border-amber-300/80 bg-white/72 px-5 py-8 text-center shadow-sm backdrop-blur-sm">
                  <div className="mx-auto mb-3 flex h-11 w-11 items-center justify-center rounded-2xl border border-amber-300/80 bg-amber-50 text-amber-900/65">
                    <LayoutGrid className="h-5 w-5" />
                  </div>
                  <div className="text-sm font-semibold tracking-tight text-stone-900">
                    {emptyTitle}
                  </div>
                  <p className="mt-2 text-xs leading-5 text-stone-700/75">
                    {emptyDescription}
                  </p>
                  <Button
                    type="button"
                    ...
                    onClick={onCreateCard}
                    disabled={!canCreate || !onCreateCard}
                    className="mt-4 border-amber-300/80 bg-white/80 text-stone-900 hover:bg-white"
                  >
                    <Plus className="h-3.5 w-3.5" />
                    新建第一张卡片
                  </Button>
