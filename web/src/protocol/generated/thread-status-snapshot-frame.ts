...
export type FrameType = "thread-status";
export type Threadid = string;
export type Phase = "idle" | "responding" | "thinking" | "tool_calling" | "waiting_approval" | "complete" | "error";
export type Sequence = number;
export type Runid = string;
export type Rungeneration = number;
export type Toolname = string | null;
export type RunEndReason = number | null;

/**
 * 新 ``/ws/thread-status`` 连接收到的 active 状态全量快照。
 */
export interface ThreadStatusSnapshotFrame {
  frame_type: "thread-status.snapshot";
  watermark: number;
  items: ThreadStatusFrame[];
}
/**
