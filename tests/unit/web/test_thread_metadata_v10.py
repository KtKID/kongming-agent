"""ThreadMetadata schema_version=10 + v9→v10 兼容懒升级单测。
...
5. ``THREAD_METADATA_SCHEMA_VERSION == 10``
"""
...
def test_v9_file_upgraded_to_v10_default_not_archived(tmp_path: Path) -> None:
    """v9 文件读出 → schema_version=10、is_archived=False（默认）。"""
...
def test_read_v11_returns_none(tmp_path: Path) -> None:
    """前向兼容拒绝：v11 文件（未来版本）返回 None。"""
