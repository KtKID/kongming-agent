...
from hosts.web.workspace.model import WorkspaceError, get_thread_meta, require_workspace_root
from network.network_log import log_network_event, log_network_exception

try:
    from hosts.web.workspace.shell import (
    ...
    *,
    ...
    try:
        ...
        log_network_exception(
            "hosts.web.routers.workspace_shell",
