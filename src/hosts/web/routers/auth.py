...
from hosts.web.auth.secrets import hash_password, verify_password
from hosts.web.errors import (
    AuthFailedError,
    NotAuthenticatedError,
    RateLimitedError,
)
from hosts.web.protocol import LoginRequest
from hosts.web.protocol.rest_models import ResetPasswordRequest
from hosts.web.rate_limit import LoginRateLimiter
from hosts.web.rate_limit import RateLimitedError as _RLError
...
async def reset_password(
    ...
    from hosts.web.auth.secrets import PASSWORD_HASH_FILENAME, _ensure_web_dir, _write_secret_text
