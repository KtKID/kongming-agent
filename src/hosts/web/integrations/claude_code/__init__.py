...
（OpenAI/Anthropic provider）平级共存于 ``src/hosts/web/`` 主线。
...
from hosts.web.integrations.claude_code.route import router
from hosts.web.shared.session_manager import SessionManager, SessionRecord
