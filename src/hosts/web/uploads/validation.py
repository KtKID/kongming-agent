...
from hosts.web.uploads.registry import EXT_BY_MIME  # 共享 MIME 白名单（单点真源）
from hosts.web.uploads.storage import AttachmentKind  # noqa: F401  # public re-export hint
