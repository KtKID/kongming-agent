...
from executors.agent_runtime.strategies.map_reduce.artifacts import (
    MapReduceArtifactWriter,
)
from executors.agent_runtime.strategies.map_reduce.contracts import (
    CoverageSummary,
    FailedShardReport,
    MapperCoverage,
    MapperInputManifest,
...
from executors.agent_runtime.strategies.map_reduce.input_materializer import (
    MapperInputMaterializer,
)
from executors.agent_runtime.strategies.map_reduce.mapper import MapperPromptBuilder
from executors.agent_runtime.strategies.map_reduce.planner import MapReducePlanner
from executors.agent_runtime.strategies.map_reduce.reducer import MapReduceReducer
from executors.agent_runtime.strategies.map_reduce.validator import (
    MapReduceMapperOutputValidator,
)
from executors.agent_runtime.subagent_manager import SubAgentRun, SubAgentTask
from executors.agent_runtime.subagent_permissions import SubAgentPermissionSpec, to_jsonable
...
class MapReduceStrategy:
            ...
            examples=(
                {
                    ...
                    "payload": {
                        ...
                        "input_source": {
                            "kind": "path_glob",
                            "root_dir": ".",
                            "include": ["src/executors/agent_runtime/**/*.py"],
                            "exclude": [".venv/**"],
                            "files": [],
                            "index_provider": "rg",
                            "input_digest": None,
    ...
    async def run(
        ...
        from executors.agent_runtime.workflow.manager import AgentWorkflowResult
